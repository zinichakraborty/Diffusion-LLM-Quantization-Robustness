...
def create_pbar(verbose, num_steps):
    if verbose:
        pbar = tqdm(total=num_steps, desc="Diffusion Steps")
        return pbar
    return None
...
def generate(
    ...
    pbar = create_pbar(verbose, steps * num_blocks)
