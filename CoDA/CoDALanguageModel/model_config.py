...
class CoDAConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        backbone_type: str = "transformer",   # NEW: "transformer" or "mamba"
        mamba_d_state: int = 64,              # NEW
        mamba_d_conv: int = 4,                # NEW
        mamba_expand: int = 2,                # NEW
        mamba_share_directions: bool = True,  # NEW (tie fwd/bwd weights)
        mamba_fuse: str = "glu",              # NEW: "glu" or "linear"
        mamba_dropout: float = 0.0,           # NEW
        **kwargs,
    ):
        ...
        self.mamba_share_directions = mamba_share_directions
        self.mamba_fuse = mamba_fuse
